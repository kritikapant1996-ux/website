...
export default function Home() {
    ...
    return (
        <div className="min-h-screen flex flex-col font-sans text-foreground relative">
            ...
            <nav className="sticky top-0 z-50 w-full border-b border-border/40 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
                <div className="container flex h-16 max-w-screen-xl items-center justify-between px-4 md:px-8 mx-auto">
                    <Link href="/" className="flex items-center space-x-2 font-bold text-2xl text-primary tracking-tight hover:opacity-90 transition-opacity">
                        <Image src="/logo.png" alt="SkillUp Logo" width={150} height={50} className="h-12 w-auto object-contain" />
                    </Link>
            ...
            {/* 2. Hero Section */}
            <section className="relative pt-20 pb-32 md:pt-32 md:pb-48 overflow-hidden bg-sky-100">
            ...
            <section className="py-24 bg-[url('/back.jpeg')] bg-cover bg-center bg-no-repeat relative" id="services">
                <div className="absolute inset-0 bg-background/80 backdrop-blur-sm"></div>
                <div className="container px-4 md:px-8 mx-auto max-w-screen-xl relative z-10">
            ...
            <section className="py-24 bg-background/60 backdrop-blur-sm" id="about">
            ...
            <footer className="bg-foreground text-background py-20">
                <div className="container px-4 md:px-8 mx-auto max-w-screen-xl text-center">
                    ...
                    <div className="mt-20 border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center text-sm text-gray-400">
                        ...
                        <p className="mt-4 md:mt-0">&copy; 2024 SkillUp Platform. All rights reserved.</p>
                    </div>
                </div>
            </footer>
        </div>
